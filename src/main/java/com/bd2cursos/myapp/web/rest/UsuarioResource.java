...
import com.bd2cursos.myapp.service.UsuarioQueryService;
import com.bd2cursos.myapp.service.UsuarioService;
...
/**
 * REST controller for managing {@link com.bd2cursos.myapp.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
